...
text = 'haohaoaho//@呼噜老K: 说的好//@ozrunner:回复@股市狂韭菜: 这些商业常识性的细节被很多人选择性忽视了。简单说，乐视群企业已经失去了商誉，很多人竟然还当他是个宝，害怕人低价强购，我乐个去啊'
    ...
    if m:
        for i in xrange(len(m)):
            ...
            for j in xrange(len(r)):
                # print r[j], '\n'
                if len(r[j])>1 and len(r[j])<1000:   # 剔除空格和部分超长的句子
...
def read_sqlite(db_path, stock):
    ...
    tmp = cu.fetchall()
    # tmp = ['haohaoaho//@呼噜老K: 说的好//@ozrunner:回复@股市狂韭菜: 这些商业常识性的细节被很多人选择性忽视了。简单说，乐视群企业已经失去了商誉，很多人竟然还当他是个宝，害怕人低价强购，我乐个去啊']
    comment_result = []
